...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        /* =========================
   Cognisense XL Courses
   ========================= */
.cs-course-actions--xl{
  margin-top: 22px;
  padding: 22px;
  border-radius: 28px;
...
.cs-course-actions--xl::after{
  content:"";
  position:absolute;
  inset:0;
  border-radius: inherit;
  background:
    radial-gradient(900px 420px at 14% 10%, rgba(250,204,21,.12), transparent 62%),
    radial-gradient(900px 460px at 86% 18%, rgba(56,189,248,.14), transparent 65%);
  opacity: .9;
  pointer-events:none;
  z-index: 0;
}
.cs-course-actions--xl > *{ position: relative; z-index: 1; }
...
body.dark-mode .cs-course-chip{ background: rgba(2,6,23,.35); }

/* Hero right visuals */
.cs-course-hero-right{
  width: min(340px, 42%);
  display:flex;
...
.cs-course-orb{
  ...
  opacity: .85;
  animation: csCourseOrbFloat 9.2s ease-in-out infinite;
}
.cs-course-orb2{
  right: 120px;
  top: 50px;
...
body.dark-mode .cs-course-badge{
...
.cs-course-card::before{
  content:"";
  position:absolute;
  inset:0;
  background:
    radial-gradient(620px 260px at 12% 0%, rgba(56,189,248,.16), transparent 60%),
    radial-gradient(620px 260px at 92% 14%, rgba(250,204,21,.12), transparent 62%);
  opacity: .22;
  pointer-events:none;
}
...
.cs-course-meta{ position: relative; z-index: 2; margin-top: 14px; }
.cs-course-name{
  font-weight: 900;
  letter-spacing: .10em;
  color: var(--ana-text, #0b1120);
...
.cs-course-sheen{
  ...
  opacity: .55;
  pointer-events:none;
  animation: csCourseSheen 6.4s ease-in-out infinite;
}
@keyframes csCourseSheen{
  0%,55%{ transform: translateX(-140%); }
  75%,100%{ transform: translateX(140%); }
}
...
.cs-course-card:hover .cs-course-go{
  background: rgba(250,204,21,.14);
  transform: translateZ(12px) translateX(3px);
}
.cs-course-card:hover .cs-course-glow{ opacity: .58; }
.cs-course-card:active{ transform: translateY(-2px) scale(.99); }

.cs-course-card:focus-visible{
  outline: 3px solid rgba(56,189,248,.55);
  outline-offset: 4px;
}

/* Dark mode tuning */
body.dark-mode .cs-course-card{ box-shadow: 0 22px 60px rgba(0,0,0,.60); }
body.dark-mode .cs-course-pill{
  color: #e5e7eb;
  background: rgba(129,140,248,.14);
  border-color: rgba(129,140,248,.45);
}
body.dark-mode .cs-course-go{
  color: #e5e7eb;
  background: rgba(129,140,248,.12);
...
@media (max-width: 1200px){
  .cs-course-hero-right{ display:none; }
  .cs-course-grid--xl{ grid-template-columns: repeat(2, minmax(0, 1fr)); }
}
@media (max-width: 560px){
  .cs-course-grid--xl{ grid-template-columns: 1fr; }
  .cs-course-actions--xl{ padding: 16px; }
  .cs-course-card{ min-height: 220px; }
}
...
<div class="main-content" id="main-content">
    ...
    <!-- Free Courses Section (Cognisense XL) -->
<section class="cs-course-actions cs-course-actions--xl" aria-label="Try our lecture video courses">
  <div class="cs-course-hero">
    <div class="cs-course-hero-left">
      <h3 class="cs-course-title">
        <span class="cs-course-dot"></span>
        Try Our Lecture Videos Courses
      </h3>
      <p class="cs-course-sub">
        Explore free resources to boost your skills — short, focused lessons built around IELTS scoring.
      </p>

      <div class="cs-course-chips" aria-hidden="true">
        <span class="cs-course-chip"><i class="fa-solid fa-circle-play"></i> Video Lessons</span>
        <span class="cs-course-chip"><i class="fa-solid fa-layer-group"></i> Section-wise</span>
        <span class="cs-course-chip"><i class="fa-solid fa-lightbulb"></i> Tips & Strategies</span>
      </div>
    </div>

    <div class="cs-course-hero-right" aria-hidden="true">
      <div class="cs-course-orb"></div>
      <div class="cs-course-orb cs-course-orb2"></div>
      <div class="cs-course-badge">
        <div class="cs-course-badge-top">Library</div>
        <div class="cs-course-badge-main">Free</div>
        <div class="cs-course-badge-sub">Watch & improve</div>
      </div>
    </div>
  </div>

  <div class="cs-course-grid cs-course-grid--xl">
    <a class="cs-course-card cs-course-sky" href="courses/listening_tips.php" aria-label="Open Listening Course">
      <div class="cs-course-top">
        <div class="cs-course-ic">🎧</div>
        <span class="cs-course-pill"><i class="fa-solid fa-play"></i> Watch</span>
      </div>
      <div class="cs-course-meta">
        <div class="cs-course-name">Listening Course</div>
        <div class="cs-course-desc">Tips for accuracy • keywords • traps</div>
      </div>
      <div class="cs-course-bottom">
        <span class="cs-course-mini"><i class="fa-solid fa-headphones"></i> Lecture videos</span>
        <span class="cs-course-go"><i class="fa-solid fa-arrow-right"></i></span>
      </div>
      <div class="cs-course-sheen" aria-hidden="true"></div>
      <div class="cs-course-glow" aria-hidden="true"></div>
    </a>

    <a class="cs-course-card cs-course-indigo" href="courses/reading_tips.php" aria-label="Open Reading Course">
      <div class="cs-course-top">
        <div class="cs-course-ic">📘</div>
        <span class="cs-course-pill"><i class="fa-solid fa-play"></i> Watch</span>
      </div>
      <div class="cs-course-meta">
        <div class="cs-course-name">Reading Course</div>
        <div class="cs-course-desc">Skimming • scanning • T/F/NG hacks</div>
      </div>
      <div class="cs-course-bottom">
        <span class="cs-course-mini"><i class="fa-solid fa-book-open"></i> Lecture videos</span>
        <span class="cs-course-go"><i class="fa-solid fa-arrow-right"></i></span>
      </div>
      <div class="cs-course-sheen" aria-hidden="true"></div>
      <div class="cs-course-glow" aria-hidden="true"></div>
    ...
    <a class="cs-course-card cs-course-gold" href="courses/writing_tips.php" aria-label="Open Writing Course">
      <div class="cs-course-top">
        <div class="cs-course-ic">✍️</div>
        <span class="cs-course-pill"><i class="fa-solid fa-play"></i> Watch</span>
      </div>
      <div class="cs-course-meta">
        <div class="cs-course-name">Writing Course</div>
        <div class="cs-course-desc">Task response • coherence • vocab</div>
      </div>
      <div class="cs-course-bottom">
        <span class="cs-course-mini"><i class="fa-solid fa-pen-nib"></i> Lecture videos</span>
        <span class="cs-course-go"><i class="fa-solid fa-arrow-right"></i></span>
      </div>
      <div class="cs-course-sheen" aria-hidden="true"></div>
      <div class="cs-course-glow" aria-hidden="true"></div>
    ...
    <a class="cs-course-card cs-course-green" href="courses/speaking_tips.php" aria-label="Open Speaking Course">
      <div class="cs-course-top">
        <div class="cs-course-ic">🗣️</div>
        <span class="cs-course-pill"><i class="fa-solid fa-play"></i> Watch</span>
      </div>
      <div class="cs-course-meta">
        <div class="cs-course-name">Speaking Course</div>
        <div class="cs-course-desc">Fluency • confidence • band vocab</div>
      </div>
      <div class="cs-course-bottom">
        <span class="cs-course-mini"><i class="fa-solid fa-microphone-lines"></i> Lecture videos</span>
        <span class="cs-course-go"><i class="fa-solid fa-arrow-right"></i></span>
      </div>
      <div class="cs-course-sheen" aria-hidden="true"></div>
      <div class="cs-course-glow" aria-hidden="true"></div>
