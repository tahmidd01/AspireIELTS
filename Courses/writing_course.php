  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    .video-card{
      ...
      /* keep your entrance behavior (cards start hidden; JS sets delay) */
      opacity: 0;
  ...
  <div class="shell">
    ...
    <header class="topbar">
      <div class="brand">
        ...
        <div>
          <div class="brand-title">Writing Course</div>
    ...
    <section class="hero" aria-label="Writing course header">
      <h1>✍️ Writing Course Playlist</h1>
      <p class="hero-sub">Watch each lesson and practice along. Fullscreen works normally—layout stays stable.</p>
    </section>
      ...
      if ($result && $result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
              ...
              <div class='video-card'>
                ...
                <div class='label'><i class='fa-solid fa-play'></i> Writing Video $num</div>
              </div>";
          }
      } else {
          echo "<div class='empty'><strong>No videos found</strong><br/>No videos found for Writing section.</div>";
      }
      $conn->close();
      ?>
    </div>
