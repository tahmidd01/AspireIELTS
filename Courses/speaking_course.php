  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    body{
      ...
      overflow-x:hidden;
      perspective: 1200px; /* harmless, keeps original feel */
    ...
    /* Dashboard button (keep href same) */
    .dashboard-btn{
      display:inline-flex;
      align-items:center;
      gap: 10px;
    ...
    .dashboard-btn:active{ transform: translateY(0) scale(.99); }
    ...
    .video-container{
      ...
      margin: 16px auto 0;
      z-index: 1;
      transform-style: preserve-3d; /* kept from original */
    }
    ...
    video{
      ...
      display:block;
      backface-visibility: hidden; /* kept */
    ...
    @media (max-width: 520px){
      .dashboard-btn{ padding: 10px 12px; border-radius: 16px; }
...
<body>
  <div class="shell">
    ...
    <header class="topbar">
      <div class="brand">
        <div class="brand-badge" aria-hidden="true"><i class="fa-solid fa-microphone"></i></div>
        <div>
          <div class="brand-title">Speaking Course</div>
          <div class="brand-sub">Lecture videos playlist • AspireIELTS</div>
        </div>
      </div>

      <!-- keep EXACT same link target/logic -->
      <a href="../dashboard.php" class="dashboard-btn" title="Back to Dashboard">
        <i class="fa-solid fa-house"></i> Dashboard
      </a>
    </header>

    <section class="hero" aria-label="Speaking course header">
      <h1>🗣️ Speaking Course Playlist</h1>
      <p class="hero-sub">Watch each lesson and practice speaking along. Fullscreen works normally—layout stays stable.</p>
    </section>
      ...
      if ($result && $result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
              ...
              <div class='video-card'>
                ...
                <div class='label'><i class='fa-solid fa-play'></i> Speaking Video $num</div>
              </div>";
          }
      } else {
          echo "<div class='empty'><strong>No videos found</strong><br/>No videos found for Speaking section.</div>";
      }
      $conn->close();
      ?>
    </div>
