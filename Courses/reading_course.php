  ...
  <style>
    ...
    *{ box-sizing:border-box; }
    ...
    body{
      ...
      overflow-x:hidden;
      perspective: 1200px; /* keeps your original vibe, harmless */
    ...
    .video-container{
      ...
      margin: 16px auto 0;
      z-index: 1;
      transform-style: preserve-3d; /* kept */
    }
    ...
    .video-card{
      ...
      /* keep your entrance logic (cards start hidden; JS sets delay) */
      opacity: 0;
  ...
  <div class="shell">
    ...
    <header class="topbar">
      <div class="brand">
        ...
        <div>
          <div class="brand-title">Reading Course</div>
    ...
    <section class="hero" aria-label="Reading course header">
      <h1>📖 Reading Course Playlist</h1>
      <p class="hero-sub">Watch the videos below to improve your reading skills. Fullscreen works normally—layout stays stable.</p>
    </section>
      ...
      if ($result && $result->num_rows > 0) {
          while ($row = $result->fetch_assoc()) {
              ...
              <div class='video-card'>
                ...
                <div class='label'><i class='fa-solid fa-play'></i> Reading Video $num</div>
              </div>";
          }
      } else {
          echo "<div class='empty'><strong>No videos found</strong><br/>No videos found for Reading section.</div>";
      }
      $conn->close();
      ?>
    </div>
